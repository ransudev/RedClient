...
public interface OptionDescription {
     ...
     * including {@link net.minecraft.class_2558}s and {@link net.minecraft.class_2568}s.
    ...
    static OptionDescription of(class_2561... description) {
        return createBuilder().text(description).build();
    }

    OptionDescription EMPTY = new OptionDescriptionImpl(class_5244.field_39003, CompletableFuture.completedFuture(Optional.empty()));
    ...
    interface Builder {
         ...
         * @return this builder
         */
        Builder text(class_2561... description);
         ...
         * @return this builder
         */
        Builder text(Collection<? extends class_2561> lines);
         ...
         * @return this builder
         */
        Builder image(class_2960 image, int width, int height);
         ...
         * @return this builder
         */
        Builder image(class_2960 image, float u, float v, int width, int height, int textureWidth, int textureHeight);
         ...
         * @return this builder
         */
        Builder image(Path path, class_2960 uniqueLocation);
         ...
         * @return this builder
         */
        Builder webpImage(class_2960 image);
         ...
         * @return this builder
         */
        Builder webpImage(Path path, class_2960 uniqueLocation);
         ...
         * A helpful utility (that is also not API safe) is {@link dev.isxander.yacl3.gui.image.ImageRendererManager#registerOrGetImage(class_2960, Supplier)}
         ...
         */
        @Deprecated
        Builder gifImage(class_2960 image);
         ...
         */
        @Deprecated
        Builder gifImage(Path path, class_2960 uniqueLocation);
