...
public class HuntingSection extends FlowLayout {
    ...
    // Cinderbat highlight UI components
    private LabelComponent cinderbatStatusLabel;
    private ButtonComponent cinderbatToggleButton;
    ...
    private void buildSection() {
        // Section header
        FlowLayout headerRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(6)
                .verticalAlignment(VerticalAlignment.CENTER);

        headerRow.child(
                UIComponents.label(Text.literal("⚔"))
                        .color(Color.ofRgb(0xFF8844))
                        .shadow(true)
        );

        headerRow.child(
                UIComponents.label(Text.literal("Hunting - Flare Combat Macro"))
                        .color(Color.ofRgb(0xFF8844))
                        .shadow(true)
        );
        ...
        // Status section
        FlowLayout statusSection = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x22000000))
                .padding(Insets.of(8));
        statusSection.gap(4);

        this.statusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        statusSection.child(this.statusLabel);

        this.keybindLabel = (LabelComponent) UIComponents.label(Text.literal("Keybind: Not Set"))
                .color(Color.ofRgb(0x888888))
                .shadow(false);
        statusSection.child(this.keybindLabel);
        
        this.combatModeLabel = (LabelComponent) UIComponents.label(Text.literal("Mode: Hyperion"))
                .color(Color.ofRgb(0xFFAA00))
                .shadow(false);
        statusSection.child(this.combatModeLabel);
        
        this.clickCountLabel = (LabelComponent) UIComponents.label(Text.literal("Click Count: 1"))
                .color(Color.ofRgb(0xFFAA00))
                .shadow(false);
        ...
        FlowLayout buttonRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .horizontalAlignment(HorizontalAlignment.LEFT);

        this.toggleButton = (ButtonComponent) UIComponents.button(
        ...
        buttonRow.child(
                UIComponents.button(Text.literal("Info"), button -> showInfo())
        ...
        FlowLayout buttonRow2 = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .horizontalAlignment(HorizontalAlignment.LEFT);

        this.modeButton = (ButtonComponent) UIComponents.button(
                Text.literal("Switch Mode"), 
                button -> cycleCombatMode()
        ).horizontalSizing(Sizing.fixed(120));
        buttonRow2.child(this.modeButton);

        this.clickButton = (ButtonComponent) UIComponents.button(
        ...
        // Spacer
        FlowLayout spacer = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.fixed(16));
        this.child(spacer);
        
        // BezalFarmer header
        FlowLayout bezalHeaderRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(6)
                .verticalAlignment(VerticalAlignment.CENTER);
        ...
        bezalHeaderRow.child(
                UIComponents.label(Text.literal("Bezal Farmer"))
                        .color(Color.ofRgb(0x00FFFF))
                        .shadow(true)
        );
        ...
        FlowLayout bezalStatusSection = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x22000000))
                .padding(Insets.of(8));
        bezalStatusSection.gap(4);

        this.bezalStatusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        ...
        FlowLayout bezalButtonRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .horizontalAlignment(HorizontalAlignment.LEFT);

        this.bezalToggleButton = (ButtonComponent) UIComponents.button(
        ...
        bezalButtonRow.child(
                UIComponents.button(Text.literal("Info"), button -> showBezalInfo())
                        .horizontalSizing(Sizing.fixed(70))
        );
        ...
        FlowLayout bezalAutoAimRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .verticalAlignment(VerticalAlignment.CENTER);

        this.bezalAutoAimLabel = (LabelComponent) UIComponents.label(Text.literal("Auto-Aim: ON"))
                .color(Color.ofRgb(0x4CAF50))
                .shadow(false);
        bezalAutoAimRow.child(this.bezalAutoAimLabel);

        this.bezalAutoAimButton = (ButtonComponent) UIComponents.button(
        ...
        FlowLayout bezalBlackholeRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .verticalAlignment(VerticalAlignment.CENTER);

        this.bezalBlackholeLabel = (LabelComponent) UIComponents.label(Text.literal("Blackhole: OFF"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        bezalBlackholeRow.child(this.bezalBlackholeLabel);

        this.bezalBlackholeButton = (ButtonComponent) UIComponents.button(
        ...
        // ===== XYZ MACRO SECTION =====
        FlowLayout xyzHeader = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(6)
                .verticalAlignment(VerticalAlignment.CENTER)
        ...
        xyzHeader.child(
                UIComponents.label(Text.literal("XYZ Lasso Macro"))
                        .color(Color.ofRgb(0xAA00FF))
                        .shadow(true)
        );
        ...
        // XYZ Status section
        FlowLayout xyzStatusSection = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x22000000))
                .padding(Insets.of(8));
        xyzStatusSection.gap(4);

        this.xyzStatusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        ...
        // XYZ Controls
        FlowLayout xyzToggleRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(6)
                .padding(Insets.of(4));

        this.xyzToggleButton = (ButtonComponent) UIComponents.button(
        ...
        // ===== CINDERBAT HIGHLIGHT SECTION =====
        FlowLayout cinderbatHeader = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(6)
                .verticalAlignment(VerticalAlignment.CENTER)
                .padding(Insets.of(0, 10, 0, 0));

        cinderbatHeader.child(
                UIComponents.label(Text.literal("🦇"))
        ...
        cinderbatHeader.child(
                UIComponents.label(Text.literal("Cinderbat Highlight"))
                        .color(Color.ofRgb(0x66FF66))
                        .shadow(true)
        );

        this.child(cinderbatHeader);

        FlowLayout cinderbatStatusSection = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x22000000))
                .padding(Insets.of(8));
        cinderbatStatusSection.gap(4);

        this.cinderbatStatusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        cinderbatStatusSection.child(this.cinderbatStatusLabel);
        this.child(cinderbatStatusSection);

        FlowLayout cinderbatControls = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .horizontalAlignment(HorizontalAlignment.LEFT);

        this.cinderbatToggleButton = (ButtonComponent) UIComponents.button(
                Text.literal("Enable Cinderbat Highlight"),
                button -> toggleCinderbatHighlight()
        ).horizontalSizing(Sizing.fixed(230));

        cinderbatControls.child(this.cinderbatToggleButton);
        this.child(cinderbatControls);
    }
    ...
    private void toggleCinderbatHighlight() {
    ...
    public void refresh() {
        ...
        if (this.cinderbatStatusLabel != null && this.cinderbatToggleButton != null) {
            refreshCinderbatHighlight();
        }
    }
    ...
    private void refreshCinderbatHighlight() {
        boolean isEnabled = CinderbatHighlightConfig.isEnabled();
        String statusText = CinderbatHighlight.getStatusText();

        this.cinderbatStatusLabel.text(Text.literal("Status: " + statusText));
        this.cinderbatStatusLabel.color(isEnabled ? Color.ofRgb(0x4CAF50) : Color.ofRgb(0xFF5252));
        this.cinderbatToggleButton.setMessage(Text.literal(isEnabled ? "Disable Cinderbat Highlight" : "Enable Cinderbat Highlight"));
    }
}
