...
public class SchedulerSection extends FlowLayout {
    ...
    private void buildSection() {
        ...
        headerRow.child(
                UIComponents.label(Text.literal("Macro Scheduler"))
                        .color(Color.ofRgb(0xAA88FF))
                        .shadow(true)
        );
        ...
        // Description
        this.child(
                UIComponents.label(Text.literal("Automatically manage macro run time and breaks"))
        ...
        this.statusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Stopped"))
                .color(Color.ofRgb(0x888888))
                .shadow(false);
        statusSection.child(this.statusLabel);

        this.timerLabel = (LabelComponent) UIComponents.label(Text.literal("Time Remaining: --:--"))
                .color(Color.ofRgb(0x888888))
                .shadow(false);
        ...
        // Break toggle button
        this.breakToggleButton = (ButtonComponent) UIComponents.button(
        ...
        FlowLayout configSection = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x22000000))
    ...
    private FlowLayout createSliderSection(
        ...
        LabelComponent valueLabel = (LabelComponent) UIComponents.label(Text.literal(initialText))
