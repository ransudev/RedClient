...
public class FishingSection extends FlowLayout {
    ...
    private void buildSection() {
        ...
        headerRow.child(
                UIComponents.label(Text.literal("Fishing Module"))
                        .color(Color.ofRgb(0x4488FF))
                        .shadow(true)
        );
        ...
        this.contentContainer = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .gap(10);
    ...
    private FlowLayout buildAutoFishingSection() {
        FlowLayout section = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x33000000))
        ...
        // Subsection title
        section.child(
                UIComponents.label(Text.literal("Auto Fishing"))
                        .color(Color.ofRgb(0x64B5F6))
                        .shadow(false)
        );

        // Status
        this.autoFishStatusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
        ...
        this.autoFishToggleButton = (ButtonComponent) UIComponents.button(
        ...
        buttonRow.child(
                UIComponents.button(Text.literal("Info"), button -> showAutoFishInfo())
    ...
    private FlowLayout buildSeaCreatureKillerSection() {
        ...
        // Subsection title
        section.child(
                UIComponents.label(Text.literal("Sea Creature Killer"))
                        .color(Color.ofRgb(0x64B5F6))
                        .shadow(false)
        );

        // Status info
        FlowLayout statusGrid = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .gap(3);

        this.sckStatusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        statusGrid.child(this.sckStatusLabel);

        this.sckModeLabel = (LabelComponent) UIComponents.label(Text.literal("Combat Mode: RCM"))
                .color(Color.ofRgb(0xAAAAAA))
                .shadow(false);
        statusGrid.child(this.sckModeLabel);

        this.sckTargetLabel = (LabelComponent) UIComponents.label(Text.literal("Target: None"))
                .color(Color.ofRgb(0xAAAAAA))
                .shadow(false);
        statusGrid.child(this.sckTargetLabel);

        this.groupKillingLabel = (LabelComponent) UIComponents.label(Text.literal("Group Killing: OFF"))
                .color(Color.ofRgb(0xAAAAAA))
                .shadow(false);
        statusGrid.child(this.groupKillingLabel);

        this.hyperionLookDownLabel = (LabelComponent) UIComponents.label(Text.literal("Hyperion Look Down: ON"))
                .color(Color.ofRgb(0xAAAAAA))
                .shadow(false);
        ...
        FlowLayout buttonRow1 = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .horizontalAlignment(HorizontalAlignment.LEFT);

        this.sckToggleButton = (ButtonComponent) UIComponents.button(
                Text.literal("Enable SCK"), 
                button -> toggleSCK()
        ).horizontalSizing(Sizing.fixed(120));
        buttonRow1.child(this.sckToggleButton);

        this.sckModeButton = (ButtonComponent) UIComponents.button(
        ...
        this.groupKillingButton = (ButtonComponent) UIComponents.button(
                Text.literal("Group: OFF"), 
                button -> toggleGroupKilling()
        ).horizontalSizing(Sizing.fixed(120));
        buttonRow2.child(this.groupKillingButton);

        this.hyperionToggleButton = (ButtonComponent) UIComponents.button(
        ...
        buttonRow2.child(
                UIComponents.button(Text.literal("Info"), button -> showSCKInfo())
                        .horizontalSizing(Sizing.fixed(70))
        );
    ...
    private FlowLayout buildSpikeHelperSection() {
        ...
        // Subsection title
        section.child(
                UIComponents.label(Text.literal("Spike Helper"))
                        .color(Color.ofRgb(0x64B5F6))
                        .shadow(false)
        );
        ...
        // Description
        section.child(
                UIComponents.label(Text.literal("Tracks closest Spike - catch at 9+ blocks distance"))
                        .color(Color.ofRgb(0xAAAAAA))
                        .shadow(false)
        );

        // Status
        this.spikeStatusLabel = (LabelComponent) UIComponents.label(Text.literal("Status: Disabled"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        ...
        this.spikeToggleButton = (ButtonComponent) UIComponents.button(
        ...
        buttonRow.child(
                UIComponents.button(Text.literal("Info"), button -> showSpikeHelperInfo())
                        .horizontalSizing(Sizing.fixed(70))
        );
        ...
        FlowLayout aimAssistRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(8)
                .horizontalAlignment(HorizontalAlignment.LEFT);

        this.spikeAimAssistLabel = (LabelComponent) UIComponents.label(Text.literal("Aim Assist: OFF"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false);
        
        aimAssistRow.child(this.spikeAimAssistLabel);

        this.spikeAimAssistButton = (ButtonComponent) UIComponents.button(
        ...
        FlowLayout infoBox = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .surface(Surface.flat(0x22000000))
                .padding(Insets.of(8));
        infoBox.gap(3);

        infoBox.child(UIComponents.label(Text.literal("• Red highlight: Too close (< 9 blocks)"))
                .color(Color.ofRgb(0xFF5252))
                .shadow(false));
        
        infoBox.child(UIComponents.label(Text.literal("• Green highlight: Good distance (≥ 9 blocks)"))
                .color(Color.ofRgb(0x66FF66))
                .shadow(false));
        
        infoBox.child(UIComponents.label(Text.literal("• Auto-switches to closest Spike"))
                .color(Color.ofRgb(0xAAAAAA))
                .shadow(false));
    ...
    private FlowLayout buildConfigurationSection() {
        ...
        // Subsection title
        section.child(
                UIComponents.label(Text.literal("Configuration"))
                        .color(Color.ofRgb(0x64B5F6))
                        .shadow(false)
        );
    ...
    private FlowLayout createSliderSection(
        ...
        FlowLayout sliderSection = (FlowLayout) UIContainers.verticalFlow(Sizing.fill(100), Sizing.content())
                .gap(4);

        // Label row with value
        FlowLayout labelRow = (FlowLayout) UIContainers.horizontalFlow(Sizing.fill(100), Sizing.content())
                .gap(4)
                .verticalAlignment(VerticalAlignment.CENTER);

        labelRow.child(
                UIComponents.label(Text.literal(labelText + ":"))
                        .color(Color.ofRgb(0xFFAB91))
                        .shadow(false)
        );

        LabelComponent valueLabel = (LabelComponent) UIComponents.label(
        ...
        // Slider
        SlimSliderComponent slider = UIComponents.slimSlider(SlimSliderComponent.Axis.HORIZONTAL);
