...
public class FlareKeybindings {
    ...
    private static final KeyBinding.Category FLARE_CATEGORY =
            KeyBinding.Category.create(Identifier.of("redclient", "flarecombat"));
    ...
    public static void updateKeybind(int keyCode) {
        if (toggleMacro != null) {
            toggleMacro.setBoundKey(InputUtil.Type.KEYSYM.createFromCode(keyCode));
